...
router.post('/anuncioCarro', (req, res) => {
    ...
    const precoCarro = parseFloat(req.body.precoCarro);
...
router.delete('/anuncioCarro/:anuncioCarroId', (req, res) => {
    ...
    const codigoAnuncioCarro = req.params.anuncioCarroId;
    console.log('Excluindo anúncio com codAnuncioCarro:', codigoAnuncioCarro);

    AnuncioCarro.destroy({ where: { codAnuncioCarro: codigoAnuncioCarro } }).then(() => {
